...
public class AlgorithmUI extends JPanel implements ActionListener {
	...
	currentFitnessLabel = new JLabel(
		TSPEADemoText.LABEL_CURRENT_FITNESS + ": ");
	...
	mutationProbability.addChangeListener(new ChangeListener() {
		...
		if (slider.getValueIsAdjusting()) {
		    ...
		    mutationProbLabel
			    .setText(TSPEADemoText.LABEL_MUTATION_PROB
				    + ": " + sliderValue);
		}
	    }
	});
	...
	populationSizeSlide.addChangeListener(new ChangeListener() {
		...
		if (slider.getValueIsAdjusting()) {
		    ...
		    String sliderValue = String.valueOf(slider.getValue());
		    populationSize
			    .setText(TSPEADemoText.LABEL_POPULATION_SIZE
				    + ": " + sliderValue);
		}
	    }
	});
	...
	parentPoolSizeSlide.addChangeListener(new ChangeListener() {
		...
		String sliderValue = String.valueOf(slider.getValue());
		parentPoolSize
			.setText(TSPEADemoText.LABEL_PARENT_POOL_SIZE
				+ ": " + sliderValue);
	    }
	});
	...
	fitnessThreshold = new JLabel(
		TSPEADemoText.LABEL_FITNESS_THRESHOLD + ": " + 11000);
	...
	JLabel predefinedSet = new JLabel(
		TSPEADemoText.LABEL_PREDEFINED_SET);
	...
	currentGenerationLabel
		.setText(TSPEADemoText.LABEL_CURRENT_GENERATION + ": "
			+ generation);
