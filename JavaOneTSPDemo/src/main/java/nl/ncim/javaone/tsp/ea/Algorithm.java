...
public class Algorithm {
	...
	public Algorithm(JavaOneTSPDemo view, int mutationProbability,
			int populationSize, int nrOfGenerations, int fitnessThreshold, int parentSelectionSize) {
		this.view = view;
	...
	private List<CandidateSolution> parentSelection() {
		 ...
		 * CandidateSolutions
		 */
		List<CandidateSolution> parents = new ArrayList<CandidateSolution>(
				population.subList(0, parentSelectionSize));
		return parents;
	}
