...
public class AlgorithmUI extends JPanel implements ActionListener {
	...
	parentSelectionSize = new JLabel(
		JavaOneTSPDemoText.LABEL_PARENT_SELECTION_SIZE + ": " + 6);
	...
	parentPoolSize = new JLabel(JavaOneTSPDemoText.LABEL_PARENT_POOL_SIZE
		+ ": " + 10);
	...
	parentPoolSizeSlide.addChangeListener(new ChangeListener() {
		...
		String sliderValue = String.valueOf(slider.getValue());
		parentPoolSize
			.setText(JavaOneTSPDemoText.LABEL_PARENT_POOL_SIZE
				+ ": " + sliderValue);
	    }
	});
	...
	parentPoolSize.setText(JavaOneTSPDemoText.LABEL_PARENT_POOL_SIZE + ": "
		+ parentPoolSizeValue);
    }
