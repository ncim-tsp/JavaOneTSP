...
public class AlgorithmUI extends JPanel implements ActionListener
{
   ...
   {
      Dimension dimension = new Dimension(DEFAULT_LAUNCHER_WIDTH, DEFAULT_LAUNCHER_HEIGHT);
   ...
   private void addAlgorithmInfoPanelToMainPanel(JPanel runPanel)
   {
      ...
      algorithmInfoPanel.setBorder(BorderFactory.createTitledBorder("Evolutionary Algorithm Runtime Info"));
   ...
   {
      mutationProbLabel = new JLabel(JavaOneTSPDemoText.LABEL_MUTATION_PROB + ": " + 10);
      ...
      mutationProbability.addChangeListener(new ChangeListener() {
         public void stateChanged(ChangeEvent ce)
         {
            ...
            if(slider.getValueIsAdjusting())
            {
               ...
               mutationProbLabel.setText(JavaOneTSPDemoText.LABEL_MUTATION_PROB + ": " + sliderValue);
            }
         }
      });
   ...
   {
      populationSize = new JLabel(JavaOneTSPDemoText.LABEL_POPULATION_SIZE + ": " + 100);
      ...
      populationSizeSlide.addChangeListener(new ChangeListener() {
         public void stateChanged(ChangeEvent ce)
         {
            ...
            if(slider.getValueIsAdjusting())
            {
               predefinedSetsComboBox.setSelectedItem(PredefinedSet.NONE);
               String sliderValue = String.valueOf(slider.getValue());
               populationSize.setText(JavaOneTSPDemoText.LABEL_POPULATION_SIZE + ": " + sliderValue);
            }
         }
      });
   ...
   {
      nrOfGenerations = new JLabel(JavaOneTSPDemoText.LABEL_NR_OF_GENERATIONS + ": " + 5000);
      ...
      nrOfGenerationsSlide.addChangeListener(new ChangeListener() {
         public void stateChanged(ChangeEvent ce)
         {
            ...
            if(slider.getValueIsAdjusting())
            {
               predefinedSetsComboBox.setSelectedItem(PredefinedSet.NONE);
               String sliderValue = String.valueOf(slider.getValue());
               nrOfGenerations.setText(JavaOneTSPDemoText.LABEL_NR_OF_GENERATIONS + ": " + sliderValue);
            }
         }
      });
   ...
   {
      fitnessThreshold = new JLabel(JavaOneTSPDemoText.LABEL_FITNESS_THRESHOLD + ": " + 11000);
      configPanel.add(fitnessThreshold);
      configPanel.add(emptyLabel);

      fitnessThresholdsSlide = new JSlider(JSlider.HORIZONTAL, 0, 20000, 11000);
      fitnessThresholdsSlide.addChangeListener(new ChangeListener() {
         public void stateChanged(ChangeEvent ce)
         {
            ...
            if(slider.getValueIsAdjusting())
            {
               predefinedSetsComboBox.setSelectedItem(PredefinedSet.NONE);
               String sliderValue = String.valueOf(slider.getValue());
               fitnessThreshold.setText(JavaOneTSPDemoText.LABEL_FITNESS_THRESHOLD + ": " + sliderValue);
            }
         }
      });
   ...
   {
      JLabel predefinedSet = new JLabel(JavaOneTSPDemoText.LABEL_PREDEFINED_SET);
   ...
   public void actionPerformed(ActionEvent event)
   {
      ...
      {
         setPredefinedSet((PredefinedSet) predefinedSetsComboBox.getSelectedItem());
      }
   }
         ...
         int fitnessThresholdValue, int parentPoolSizeValue, int parentSelectionSizeValue)
   {
      ...
      mutationProbLabel.setText(JavaOneTSPDemoText.LABEL_MUTATION_PROB + ": " + mutationProbabilityValue);

      populationSizeSlide.setValue(populationSizeValue);
      populationSize.setText(JavaOneTSPDemoText.LABEL_POPULATION_SIZE + ": " + populationSizeValue);

      nrOfGenerationsSlide.setValue(nrOfGenerationsValue);
      nrOfGenerations.setText(JavaOneTSPDemoText.LABEL_NR_OF_GENERATIONS + ": " + nrOfGenerationsValue);

      fitnessThresholdsSlide.setValue(fitnessThresholdValue);
      fitnessThreshold.setText(JavaOneTSPDemoText.LABEL_FITNESS_THRESHOLD + ": " + fitnessThresholdValue);
   ...
   {
      currentGenerationLabel.setText(JavaOneTSPDemoText.LABEL_CURRENT_GENERATION + ": " + generation);

      String fitnessString = (Double.isNaN(fitness)) ? "" : String.valueOf(fitness);
      currentFitnessLabel.setText(JavaOneTSPDemoText.LABEL_CURRENT_FITNESS + ": " + fitnessString);
   }
}
